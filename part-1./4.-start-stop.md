...
한 모드만 골라 운영하세요. 설치 경로는 한글/공백 없는 영문(예: **`C:\Odyssey\`**)을 권장합니다.
{% endhint %}
...
`logs/live/`<mark style="color:red;">**`system.log`**</mark>(또는 `logs/`<mark style="color:red;">**`odyssey-pipeline.out`**</mark>)에 다음과 유사한 메시지가 출력됩니다.
