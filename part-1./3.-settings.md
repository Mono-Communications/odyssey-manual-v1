...
{% hint style="warning" %}
**VMS 발송** 기능을 사용하는 고객사의 경우, msg 그룹의 게이트웨이는 `KT`만 제공됩니다. `CPAAS` 게이트웨이는 VMS 발송 기능을 제공하지 않습니다.
{% endhint %}
...
{% hint style="info" %}
옵션 전체 설명과 추가 항목(`expiry-option`, `report-cycle` 등)은 [14. 계정 설정 (sessions)](../part-2./14.-sessions/) 참고.
{% endhint %}
