...
<figure><img src="../../.gitbook/assets/11_모니터링_발송통계.png" alt="그림 11. 모니터링 화면 — 발송 통계 (메시지 타입별 / 시간대별 / 템플릿별, CSV·Excel 내보내기)"><figcaption><p>그림 11. 모니터링 화면 — 발송 통계 (메시지 타입별 / 시간대별 / 템플릿별, CSV·Excel 내보내기)</p></figcaption></figure>
