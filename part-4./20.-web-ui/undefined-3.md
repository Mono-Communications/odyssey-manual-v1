...
<figure><img src="../../.gitbook/assets/image (4).png" alt="그림 12. 데이터베이스 설정 — 연결 정보 (DB 타입, JDBC URL, 사용자명)"><figcaption><p>그림 12. 데이터베이스 설정 — 연결 정보 (DB 타입, JDBC URL, 사용자명)</p></figcaption></figure>
